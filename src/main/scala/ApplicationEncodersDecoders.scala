...
object ApplicationEncodersDecoders {
  ...
  implicit val contributorsDecoder: Decoder[Contributors] =
    new Decoder[Contributors] {
  ...
  implicit def contributorsEntityDecoder[F[_]: Sync]
      : EntityDecoder[F, Contributors] = jsonOf
  implicit val contributorsEncoder: Encoder[Contributors] =
    deriveEncoder[Contributors]
  implicit def contributorsEntityEncoder[F[_]: Applicative]
      : EntityEncoder[F, List[Contributors]] = jsonEncoderOf
}
