...
lazy val glassfishVersion              = "3.0.2"
lazy val javaxwxVersion                = "2.1.1"
...
lazy val applicationSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.glassfish.jersey.ext.cdi" % "jersey-cdi1x"                    % glassfishVersion,
    "javax.ws.rs"                  % "javax.ws.rs-api"                 % javaxwxVersion
  ),
  libraryDependencies ++= Seq(
    "io.circe" %% "circe-core",
